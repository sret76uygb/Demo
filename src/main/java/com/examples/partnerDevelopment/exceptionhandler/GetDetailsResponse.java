 ...
 * 
 */
package com.examples.partnerDevelopment.exceptionhandler;
...
public class GetDetailsResponse {
	...
	public GetDetailsResponse(String responseCode, String messages) {
		super();
		this.responseCode = responseCode;
		this.messages = messages;
	}
	public GetDetailsResponse(String userId,Boolean isTvc) {
		super();
		this.userId = userId;
		this.isTvc=isTvc;
	}
	public GetDetailsResponse(String partnerUtilization,Integer percentage) {
		super();
		this.partnerUtilization = partnerUtilization;
		this.percentage=percentage;
	}

	public GetDetailsResponse(String responseCode, String messages, Collection<?> result) {
		super();
		this.responseCode = responseCode;
		this.messages = messages;
		this.result = result;
